...
namespace UnityEditor.Experimental.Rendering.HDPipeline
{
    ...
    public class VolumetricFogEditor : AtmosphericScatteringEditor
    {
        ...
        static GUIContent s_AlbedoLabel                 = new GUIContent("Single Scattering Albedo", "The color this fog scatteres light to.");
        static GUIContent s_MeanFreePathLabel           = new GUIContent("Base Fog Distance", "Density at the base of the fog. Determines how far you can see through the fog in Unity units.");
        static GUIContent s_BaseHeightLabel             = new GUIContent("Base Height", "Height of the boundary between the constant and exponential fog.");
        static GUIContent s_MeanHeightLabel             = new GUIContent("Mean Height", "Rate of falloff for the height fog. Higher values stretch the fog vertically.");
        ...
        static GUIContent s_GlobalLightProbeDimmerLabel = new GUIContent("Global Light Probe Dimmer", "Reduces the intensity of the global Light Probe that the sky generates.");
        static GUIContent s_EnableDistantFog            = new GUIContent("Distant Fog", "Activates the fog with precomputed lighting behind the volumetric section of the Camera’s frustum.");
