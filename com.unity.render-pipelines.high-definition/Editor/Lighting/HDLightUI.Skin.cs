...
namespace UnityEditor.Experimental.Rendering.HDPipeline
{
    partial class HDLightUI
    {
        sealed class Styles
        {
            ...
            public readonly GUIContent bakedShadowRadius = new GUIContent("Radius", "Controls the amount of artificial softening the baking process applies to the edges of shadows cast by this Point or Spot Light.");
            ...
            public readonly GUIContent color = new GUIContent("Color", "Controls the color this Light emits.");
            public readonly GUIContent useColorTemperature = new GUIContent("Color Temperature", "Choose between RGB and Temperature mode for this Light's color.");
            public readonly GUIContent colorFilter = new GUIContent("Filter", "Tints the Light source.");
            public readonly GUIContent colorTemperature = new GUIContent("Temperature", "Correlates a color for the Light based on a temperature value (in Kelvin). For reference, White is 6500K.");
            ...
            public readonly GUIContent maxSmoothness = new GUIContent("Max Smoothness", "Very low cost way of faking spherical area lighting. This modifies the roughness of the Material Lit and is useful when the specular highlight is either too small or too sharp.");
            public readonly GUIContent lightRadius = new GUIContent("Emission Radius", "Softena the core of the Punctual Light to create fill lighting.");
            ...
            public readonly GUIContent nonLightmappedOnly = new GUIContent("Shadowmask Mode", "Sets the shadowmask behaviour when using Mixed lighting. Distance Shadowmask: HDRP uses real-time shadows to Shadow Distance and baked shadows after. Shadowmask: Static shadow casters always use baked shadows.");
            public readonly GUIContent lightDimmer = new GUIContent("Dimmer", "Dims the Light as a percentage of its intensity. This is useful for reducing the intensity of multiple Lights simultaneously without needing know the intensity of each Light.");
            ...
            public readonly GUIContent shapeWidthRect = new GUIContent("Size X", "Width of the Rectangle Light.");
            public readonly GUIContent shapeHeightRect = new GUIContent("Size Y", "Height of the Rectangle Light.");
            ...
            public readonly GUIContent shapeWidthBox = new GUIContent("Size X", "Width of the Box Light.");
            public readonly GUIContent shapeHeightBox = new GUIContent("Size Y", "Height of the Box Light.");
            ...
            public readonly GUIContent luxAtDistance = new GUIContent("At", "Distance, in meters, where a surface receives the amount of light equivalent to the provided number of Lux");

            // Volumetric Additional light data
            public readonly GUIContent volumetricEnable = new GUIContent("Enable", "Enable Volumetrics for this Light.");
            public readonly GUIContent volumetricDimmer = new GUIContent("Dimmer", "Modify the intensity of the scattered Volumetric lighting.");
            ...
            public readonly GUIContent shadowResolution = new GUIContent("Resolution", "Controls the rendered resolution of the shadow maps. A higher resolution increases the fidelity of shadows at the cost of GPU performance and memory usage.");
            public readonly GUIContent shadowFadeDistance = new GUIContent("Fade Distance", "Shadows fade at this distance before HDRP culls them completely. This minimizes popping.");
