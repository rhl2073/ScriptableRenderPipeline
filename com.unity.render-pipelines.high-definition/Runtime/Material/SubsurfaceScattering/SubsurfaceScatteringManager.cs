...
namespace UnityEngine.Experimental.Rendering.HDPipeline
{
    public class SubsurfaceScatteringManager
    {
        ...
        public void PushGlobalParams(HDCamera hdCamera, CommandBuffer cmd, DiffusionProfileSettings sssParameters)
        {
            ...
            cmd.SetGlobalInt(HDShaderIDs._EnableSubsurfaceScattering, hdCamera.frameSettings.IsEnable(FrameSettingsField.SubsurfaceScattering) ? 1 : 0);
            unsafe
            {
            ...
            cmd.SetGlobalVectorArray(HDShaderIDs._TransmissionTintsAndFresnel0, hdCamera.frameSettings.IsEnable(FrameSettingsField.Transmission) ? sssParameters.transmissionTintsAndFresnel0 : sssParameters.disabledTransmissionTintsAndFresnel0);
        ...
        {
            if (sssParameters == null || !hdCamera.frameSettings.IsEnable(FrameSettingsField.SubsurfaceScattering))
                return;
            ...
            using (new ProfilingSample(cmd, "Subsurface Scattering", CustomSamplerId.SubsurfaceScattering.GetSampler()))
            {
                ...
                if (NeedTemporarySubsurfaceBuffer() || hdCamera.frameSettings.IsEnable(FrameSettingsField.MSAA))
                {
                ...
                int sssKernel = hdCamera.frameSettings.IsEnable(FrameSettingsField.MSAA) ? m_SubsurfaceScatteringKernelMSAA : m_SubsurfaceScatteringKernel;
